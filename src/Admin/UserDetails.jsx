...
<img
      style={{ height: "70px",float: "right" }}
        ...
        <img
    style={{width: "25px",marginRight: "10px", height: "25px" ,marginTop:"2%"}}
    src={leftIcon}
    alt="leftIcon "
    onClick={Navigate}
  />
  
       <b className="headerName" style={{marginTop:"2%"}}>Add New User</b>
      ...
      <Card style={{ height: "70vh" ,marginTop:"2%"}}>
        <label>
